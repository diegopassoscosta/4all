 ...
 * @author SIMATTOS
 */
public class NewAlterarQuartos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(quarto.Alterar(Integer.parseInt(request.getParameter("codigo")))){
                out.println("<script>");
                    out.println("alert('Alterado com sucesso.');");                                        
                out.println("</script>");                 
                String irParaJsp = "/listar_quartos.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(NewAlterarQuartos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
