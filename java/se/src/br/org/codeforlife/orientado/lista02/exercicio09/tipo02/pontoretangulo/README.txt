...
c. Possua uma função para imprimir os valores da classe Ponto Possua uma função para encontrar o
centro de um Retângulo.
d. Você deve criar alguns objetos da classe Retangulo.
e. Cada objeto deve ter um vértice de partida, por exemplo, o vértice inferior
f. Esquerdo do retângulo, que deve ser um objeto da classe Ponto.
